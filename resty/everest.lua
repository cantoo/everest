...
--local success, mod = pcall(require, table_concat({server_port, res1, method_resources_file}, "."))
local success, mod = true, require(table_concat({server_port, res1, method_resources_file}, "."))
